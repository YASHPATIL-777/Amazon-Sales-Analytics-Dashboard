...
The **Amazon Sales Analytics Dashboard** is an interactive Business Intelligence solution developed in **Microsoft Power BI** to analyze Amazon sales performance, customer behavior, product profitability, and regional sales trends.

The dashboard transforms raw sales data into meaningful business insights using **Power Query**, **DAX**, **Data Modeling**, and interactive visualizations.
...
### 🏠 Home
Project introduction with interactive navigation.
...
│
├── Dashboard
│   └── Amazon Sales Analytics Dashboard.pbix
│
├── Dataset
│   └── Amazon_Sales.csv
│
...
> Add screenshots of all dashboard pages inside the **Images** folder and update them below.
